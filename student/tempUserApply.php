    ...
    <div id = "page-wrapper">
                          ...
                          <table>
                            <thead>
                               <tr>
                                 ...
                                 <th style="padding-left: 4%">Scholar Type</th>
                          ...
                          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" name="login" >
                                <tr>
                                  ...
                                  <select name="class" style="display: inline;">
                                    ...
                                    <option value="diploma">Post Graduate</option>
                                 ...
                                 <td style="padding-left: 4%">
                                  <select name="religion" style="display: inline;">
                                    <option value="select" selected>Select</option>
                                    <option value="buddhism">Special Need</option>
                                    <option value="christian">Disable</option>
                                    <option value="hindu">Vulnerable</option>
                                    <option value="jain">Needy</option>
                                    <option value="muslim">Very Needt</option>
                                    <option value="parsi">Financial Need</option>
                                    <option value="sikh">Other Reasons</option>
                                  </select>
                                </td>
                                <td style="padding-left: 4%">
              ...
              <div class="row">
                <div class="4u 12u(narrower)">
                  ...
                  <section>
                    ...
                    <p>You apply and qualify based on your eligibility and financial need.</p>
                    <footer>
                      <ul class="buttons">
                ...
                <div class="4u 12u(narrower)">
                  ...
                  <section>
                    ...
                    <p>This Application is safe secure and free from favourism etc.</p>
                    <footer>
                      <ul class="buttons">
                        <li><a href="#" class="button small">Learn More</a></li>
                      </ul>
                ...
                <div class="4u 12u(narrower)">
                  ...
                  <section>
                    <header>
                      <h3>We care and value you</h3>
                    </header>
                    <p>Let us do this for your well being and academic progresss.</p>
                    <footer>
                      <ul class="buttons">
                        <li><a href="#" class="button small">Learn More</a></li>
                      </ul>
      ...
      <!-- Footer -->
        <footer id="footer">
          ...
          <ul class="copyright">
            <li>&copy; KGL&SS</li><li>Design: mosesmmata70@gmail.com<a href="http://html5up.net"></a></li>
          </ul>
