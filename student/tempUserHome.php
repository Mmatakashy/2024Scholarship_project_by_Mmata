    ...
    <div id = "page-wrapper">
      ...
      <!-- Header -->
        ...
        <article id = "main">
          ...
          <section class="wrapper style2 container special-alt">
            <div class="row 50%">
              <div class="8u 12u(narrower)">
                ...
                <header>
                  <h2>KENYA'S LARGEST SCHOLARSHIP PLATFORM</h2>
                </header>
                <p>Making Education Affordable<br><br><br>To all Kenya students pursuing higher education</p>
                <footer>
                  <ul class="buttons">
          ...
          <section class="wrapper style3 container special">
            ...
            <header class="major">
              ...
              <h4>Choosing the right scholarship is a daunting task. Pick relevant scholarships and stand a get into government aid.</h4>
            </header>
            ...
            <div class="row">
              <div class="6u 12u(narrower)">
                ...
                <section>
                  <a href="#" class="image featured"><img src="../images/scholarships/graduates.jpg" alt="" /></a>
                  <header>
              ...
              <div class="6u 12u(narrower)">
                ...
                <section>
                  <a href="#" class="image featured"><img src="../images/scholarships/disabled.jpg" alt="" /></a>
                  <header>
            ...
            <div class="row">
              <div class="6u 12u(narrower)">
                ...
                <section>
                  <a href="#" class="image featured"><img src="../images/scholarships/family.jpg" alt="" /></a>
                  <header>
              ...
              <div class="6u 12u(narrower)">
                ...
                <section>
                  <a href="#" class="image featured"><img src="../images/scholarships/forgot.jpg" alt="" /></a>
                  <header>
          ...
          <section class="wrapper style5 container special">
            <header>
              <h2><strong>Most popular Cities where scholarship is available</Strong></h2>
            <header>

            <div class="row1">
              <div class="column1">
                <a href="#">
                  <img src="../images/nai.jpg" alt="Ahmedabad" style="width:100%" >
                  <span style="display:block;">Scholarship in </span><b>Nairobi</b>
                </a>
              </div>
              <div class="column1">
                <a href="#">
                  <img src="../images/vasha.jpg" alt="Mumbai" style="width:100%">
                  <span style="display:block;">Scholarship in </span><b>Naivasha</b>
                </a>
              </div>
              <div class="column1">
               <a href="#">
                 <img src="../images/nak.jpg" alt="Chennai" style="width:100%">
                 <span style="display:block;">Scholarship in </span><b>nakuru</b>
               </a>
             </div>
            </div>
        </section>
              ...
              <div class="row">
                ...
                <div class="4u 12u(narrower)">
                  <section>
                    ...
                    <footer style="padding-left: 50px; text-align: left;">
                      <ul>
                        <li><a href="#">Top Scholarships of Nairobi</a></li>
                        <li><a href="#">Top Scholarships of Mombasa</a></li>
                        <li><a href="#">Top Scholarships of Nakuru</a></li>
                        <li><a href="#">Top Scholarships of Kitale</a></li>
                        <li><a href="#">Top Scholarships of Nailvasha</a></li>
                        <li><a href="#">Top Scholarships of Eldoret</a></li>
                        <li><a href="#">Top Scholarships of Trans-Nzoia</a></li>
                        <li><a href="#">Top Scholarships of Marakwet</a></li>
                      </ul>
                    </footer>
                  </section>
                </div>
                ...
                <div class="4u 12u(narrower)">
                  <section>
                    ...
                    <footer style="padding-left: 50px; text-align: lefc">
                      <ul>
                        <li><a href="#">Top Scholarships for counties 1 to 10</a></li>
                        <li><a href="#">Top Scholarships for Counties 11, 12</a></li>
                        <li><a href="#">Top Scholarships for county 12 passed</a></li>
                  ...
                  <section>
                    ...
                    <footer style="padding-left: 50px; text-align: left;">
                      <ul>
                        ...
                        <li><a href="#">Top Scholarships for Bachelors Students</a></li>
        ...
        <section id="cta">
          <header>
            ...
            <p>that will hep your future glow and be of impact.</p>
          </header>
          <footer>
            <ul class="buttons">
      ...
      <!-- Footer -->
        <footer id="footer">
          ...
          <ul class="copyright">
            <li>&copy; All rights reserved</li><li>Design: @mosesmmata70@gmail.com <a href="#">MKM</a></li>
          </ul>
