    ...
    <div id = "page-wrapper">
      ...
      <!-- Main -->
          ...
          <header class="special container">
            ...
            <section class="wrapper style4 container">
              ...
              <form action="../backend/userdocupload.php" method="post" enctype="multipart/form-data">
                  ...
                  <label><b>1. <u>ID Card : </u></b></label>
                  <label>This must contain two copies of ID Card, both front and back side copy.scanned into one pdf and upload it HERE(MAX SIZE : 800kb)<span style="color: red">*</span> </label>
                  ...
                  <label>This must contain Receipt of the fees of entire year(scanned into one pdf if you have more than one document) and upload it HERE(MAX SIZE : 800kb)<span style="color: red">*</span> </label>
                  ...
                  <label>This must contain first page of your saving account passbook.Deatils such as your fullname, postal code, bank account number, branch name must be clearly visible in the document (MAX SIZE : 800kb)<span style="color: red">*</span> </label>
        ...
        <footer id="footer">
          ...
          <ul class="copyright">
            <li>&copy; KGL&SS</li><li>Design: mosesmmata70@gmail.com <a href="http://html5up.net">HTML5 UP</a></li>
          </ul>
        </footer>
    </div>
