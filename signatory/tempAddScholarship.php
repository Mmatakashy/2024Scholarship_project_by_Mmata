									...
									<section>
										...
										<header>
                         				...
                         				<form method = "post" name = "scholarshiplist" id = "scholarshiplist" action = "../backend/adminAddDelSch.php" enctype="multipart/form-data">
				                            ...
				                            <br><input type = "text" name = "schname" placeholder="Eg:Kenya Government New Scholarship Application Model" required>
				                            <br><br>
				                            ...
				                            <select name="degree" style="padding-top: 10px;padding-bottom: 10px; padding-left: 5%">
			                                    ...
			                                    <option value="class10">Certificate</option>
			                                    <option value="class11">Diploma</option>
			                                    <option value="class12passed">Degree</option>
			                                    <option value="diploma">Post Graduates</option>
				                            ...
				                            <label style="font-size: 15px;">This is a scholarship for a particular gender ...</label><br>
				                            <input type="checkbox" name="religion[]" value="buddhism">Special Need<br>
				                            <input type="checkbox" name="religion[]" value="christian">Disable<br>
				                            <input type="checkbox" name="religion[]" value="hindu">Vulnerable<br>
				                            <input type="checkbox" name="religion[]" value="jain">Needy<br>
				                            <input type="checkbox" name="religion[]" value="Muslim">Very Needy<br>
				                            <input type="checkbox" name="religion[]" value="Parsi">Financial Boosts<br>
				                            <input type="checkbox" name="religion[]" value="Sikh">Other Reasons<br>
											<br><br>
